    ...
    <div class="container-fluid page">
      <div class="page_inner">
        <ul class="breadcrumb">
          ...
          <li class="active">A Light in the Attic
          </li>
        </ul>
        <div id="messages">
        </div>
...
'''
parsel = Selector(text=html,encoding='utf-8')
detail = {}
for row in parsel.xpath('//table[@class = "table table-striped"]/tr'):
...
result = {
    'title' : parsel.xpath('//div[@class = "col-sm-6 product_main"]/h1/text()').get().strip(),
    'price' : parsel.xpath('//p[@class = "price_color"]/text()').get().strip(),
    "stock" : parsel.xpath('normalize-space(//p[@class = "instock availability"])').get(),
    "rating" : parsel.xpath('//p[@class = "star-rating Three"]/@class').get().strip(),
    "description" : parsel.xpath('//p[preceding-sibling::div]/text()').get().strip(),
    "image" : parsel.xpath('//div[@class = "carousel-inner"]/div/img/@src').get().strip(),
    "details" : detail
}
# print(result)
